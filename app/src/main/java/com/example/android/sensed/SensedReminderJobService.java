...
public class SensedReminderJobService extends JobService {
    ...
    public boolean onStartJob(final JobParameters jobParameters) {
        ...
        mBackgroundTask = new AsyncTask() {
            ...
            protected Object doInBackground(Object[] params) {
                Context context = SensedReminderJobService.this;
                ReminderTasks.executeTask(context, ReminderTasks.ACTION_ENTRY_REMINDER);
                return null;
            }
